...
class CompositeTSection(CompositeBaseSection):
    """Compostie: T Section"""
    ...
    def _generate_shape_vertices(self, dimensions, dimensions_sub, options):
        ...
        psc_t_coordinates = ShapeGenerator.generate_psc_t_shape(
        ...
        ref_dimension = psc_t_coordinates["reference"]
        
        psc_t_coordinates = TransFormGeometry.translate_coordinates(
            psc_t_coordinates,
            z_offset= -(tc + Hh)
        )
        
        psc_y = psc_t_coordinates["y"]
        psc_z = psc_t_coordinates["z"]
        ...
        if joint_count == 0:
            g_point_3 = [psc_y[6], psc_z[6]]
            g_point_4 = [psc_y[4], psc_z[4]]
        elif joint_count == 1:
            g_point_3 = [psc_y[7], psc_z[7]]
            g_point_4 = [psc_y[5], psc_z[5]]
        elif joint_count == 2:
