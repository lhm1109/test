...
class T22CombinedSection(CombinedBaseSection):
    """COMBINED: 2T(Web Opened H) Shape 2 Section"""
    ...
    def _generate_shape_vertices(self, dimensions):
        ...
        rotated_tb_shape_coords = TransFormGeometry.rotate_coordinates(tt_shape_coords, 180)
        trans_tb_shape_coords = TransFormGeometry.translate_coordinates(tb_shape_coords, 0, -C)

        ycot = rotated_tb_shape_coords["y"]
        zcot = rotated_tb_shape_coords["z"]
