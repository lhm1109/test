...
class C21WebPlateSection(CombinedBaseSection):
    """COMBINED: 2C with Web Plate 1 Section"""
    ...
    def _generate_shape_vertices(self, dimensions):
        ...
        rotated_cb_shape_coords = TransFormGeometry.rotate_coordinates(c_shape_coords, 270)
        
        trans_ct_shape_coords = TransFormGeometry.translate_coordinates(rotated_ct_shape_coords, -H/2, Bs/2)
        trans_cb_shape_coords = TransFormGeometry.translate_coordinates(rotated_cb_shape_coords, H/2, -Bs/2)
