...
class HC1CombinedSection(CombinedBaseSection):
    """COMBINED: H-C Combined Shape Section"""
    ...
    def _generate_shape_vertices(self, dimensions):
        ...
        trans_h_shape_coords = TransFormGeometry.translate_coordinates(h_shape_coords, 0, -twc)
        rotated_c_shape_coords = TransFormGeometry.rotate_coordinates(c_shape_coords, 270)
        ...
        # 기준 좌표 추출
        point_1 = [ycoc[1], zcoc[1]]
        point_2 = [ycoc[-1], zcoc[-1]]
