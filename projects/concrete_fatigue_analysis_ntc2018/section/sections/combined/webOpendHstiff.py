...
class WebOpendHStiffenedSection(CombinedBaseSection):
    """COMBINED: Web Opened H with Stiffener Section"""
    ...
    def _generate_shape_vertices(self, dimensions):
        ...
        trans_hb_shape_coords = TransFormGeometry.translate_coordinates(hb_shape_coords, 0, -Ht-C)
        ...
        point_3 = [ycob[6], zcob[6]]
        point_4 = [ycob[5], zcob[5]]
        
        point_1_h_t = [ycot[0], zcot[0]]
        point_2_h_t = [ycot[-2], zcot[-2]]
        point_3_h_t = [ycot[5], zcot[5]]
        point_4_h_t = [ycot[6], zcot[6]]
        
        point_1_h_b = [ycob[0], zcob[0]]
        point_2_h_b = [ycob[-2], zcob[-2]]
        point_3_h_b = [ycob[5], zcob[5]]
        point_4_h_b = [ycob[6], zcob[6]]
