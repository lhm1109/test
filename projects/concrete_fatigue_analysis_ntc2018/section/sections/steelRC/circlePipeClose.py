...
class CirclePipeCloseSection(SRCBaseSection):
    """SRC: CirclePipeClose Section"""
    ...
    def _generate_shape_vertices(self, dimensions, options):
        ...
        point_1_c_encase = [0, Hc/2]
        point_2_c_encase = [Hc/2, 0]
        point_3_c_encase = [0, -Hc/2]
        point_4_c_encase = [-Hc/2, 0]
